...
public class ball : MonoBehaviour
{
  ...
  // Use this for initialization
    ...
    //TODO: Why is it bottom border +20? Editing doesn't seem to change anything
		bottomBorder = Camera.main.GetComponent<mainscript>().bottomBorder + 20;
...
public void FindLight(GameObject activatedByBall)
{
  ...
  */
  ...
  void StopBall(bool pulltoMesh = true, Transform otherBall = null)
  {
    ...
    // commenting this out doesn't seem to have any effect
    /*
...
void DestroyLine()
{
	...
	mainscript.Instance.StartCoroutine(mainscript.Instance.clearDisconnectedBalls());
}
